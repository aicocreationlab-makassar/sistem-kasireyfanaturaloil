...
export default async function DashboardPage() {
  ...
  return <><RealtimeRefresh tables={["products","sales"]}/><main className="page">
    ...
    <div className="grid metrics">
      ...
      <article className="card metric"><div className="label">Total Stock Units</div><div className="value">{number(summary.stock)}</div><div className="tiny">Produk aktif</div></article>
    </div>
